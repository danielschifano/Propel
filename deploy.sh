...
parse_args() {
  ...
  default_username=${GIT_DEPLOY_USERNAME:-danielschifano}
  default_email=${GIT_DEPLOY_EMAIL:-schifano.daniel@gmail.com}

  #repository to deploy to. must be readable and writable.
  repo=${GIT_DEPLOY_REPO:-git@github.com:danielschifano/Propel}
